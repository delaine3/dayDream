    ...
    {writing_excercise.map((writing_excercise) => (
      <div id='my-card'  key={writing_excercise._id}>
        <div className="view-card-writ">
          ...
          <div >
            <p className="label blurb ">Prompt: <span className='char-info'>{writing_excercise.randomWritingExcercise}</span></p>
            <p className="label blurb">Response: <span className='char-info'>{writing_excercise.promt_text_area_contents}</span> </p>
