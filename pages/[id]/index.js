...
<br/>
      <div className="view-card">
        ...
        <div >
            ...
            <p className="label places_lived">Places lived: <span className='char-info'>{character.places_lived}</span></p>
            <p className="label age">Age:<span className='char-info'>{character.age}</span> </p>
            <p className="label socioeconomic_status">Socioeconomic Status: <span className='char-info'> {character.socioeconomic_status}</span></p>
            <p className="label birth_place">Birth Place: <span className='char-info'> {character.birth_place}</span></p>
            <p className="label birth_order">Birth Order: <span className='char-info'> {character.birth_order}</span></p>

            <p className="label into_astrology">Into Astrology:<span className='char-info'> {character.into_astrology? <span>Yes</span> : <span>No</span>}</span></p>
