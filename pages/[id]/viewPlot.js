...
<br/>
        ...
        <div >
            <p className="label charachter_name">Prompt:<span className='char-info'>{plot.plot_idea}</span></p>
            <p className="label places_lived">Response: <span className='char-info'>{plot.plot}</span></p>   
