...
return(
  <div>
    <h1>
   <Link href="/newPlot">
    <button className='newFormButton'> <a>Add plot</a> </button> 
  </Link></h1>
    <div className='grid'>
    ...
    {plot.map((plot) => (
      <div id='my-card'  key={plot._id}>
        <div className="view-card-writ">
          ...
          <div >
            <p className="label blurb ">Prompt: <span className='char-info'>{plot.plot_idea}</span></p>
            <p className="label blurb">Response: <span className='char-info'>{plot.plot}</span> </p>
            {/* Extra plot Info: Likes and Dislikes */}
